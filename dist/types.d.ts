...
export declare type SLInteraction<T extends CommandType = CommandType> = CommandTypes[T]['interaction'] & {
    member: GuildMember;
};
export declare type CommandExecuteObject<T extends CommandType = CommandType> = CommandTypes[T]['callback'] & {
